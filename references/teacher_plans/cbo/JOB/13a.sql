...
PushedFilters: [IsNotNull(country_code), EqualTo(country_code,[de]), IsNotNull(id)]
ReadSchema: struct<id:int,country_code:string>

(2) Filter
Input [2]: [id#23, country_code#25]
Condition : ((isnotnull(country_code#25) AND (country_code#25 = [de])) AND isnotnull(id#23))
...
(4) BroadcastExchange
Input [1]: [id#23]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=3349]
...
Input [1]: [id#30]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=3353]
...
Input [1]: [movie_id#33]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=3357]
...
Input [1]: [id#293]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=3360]
...
(24) Project
Output [3]: [movie_id#33, id#39, title#40]
Input [5]: [movie_id#33, id#39, title#40, kind_id#42, id#293]

(25) BroadcastExchange
Input [3]: [movie_id#33, id#39, title#40]
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[0, int, true] as bigint), 32) | (cast(input[1, int, true] as bigint) & 4294967295))),false), [plan_id=3364]
...
Input [1]: [id#210]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=3367]
...
(34) Project
Output [5]: [movie_id#33, id#39, title#40, movie_id#218, info#220]
Input [7]: [movie_id#33, id#39, title#40, movie_id#218, info_type_id#219, info#220, id#210]

(35) Exchange
Input [5]: [movie_id#33, id#39, title#40, movie_id#218, info#220]
Arguments: hashpartitioning(movie_id#33, movie_id#218, id#39, 200), ENSURE_REQUIREMENTS, [plan_id=3375]
...
(40) Filter
Input [2]: [id#295, info#296]
Condition : ((isnotnull(info#296) AND (info#296 = release dates)) AND isnotnull(id#295))
...
Input [1]: [id#295]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=3370]
...
Input [4]: [movie_id#213, info_type_id#214, info#215, id#295]

(45) Exchange
Input [2]: [movie_id#213, info#215]
Arguments: hashpartitioning(movie_id#213, movie_id#213, movie_id#213, 200), ENSURE_REQUIREMENTS, [plan_id=3376]
...
Input [7]: [movie_id#33, id#39, title#40, movie_id#218, info#220, movie_id#213, info#215]

(49) SortAggregate
Input [3]: [info#215, info#220, title#40]
Keys: []
Functions [3]: [partial_min(info#215), partial_min(info#220), partial_min(title#40)]
Aggregate Attributes [3]: [min#302, min#303, min#304]
Results [3]: [min#305, min#306, min#307]

(50) Exchange
Input [3]: [min#305, min#306, min#307]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=3383]

(51) SortAggregate
Input [3]: [min#305, min#306, min#307]
Keys: []
Functions [3]: [min(info#215), min(info#220), min(title#40)]
Aggregate Attributes [3]: [min(info#215)#297, min(info#220)#298, min(title#40)#299]
Results [3]: [min(info#215)#297 AS release_date#285, min(info#220)#298 AS rating#286, min(title#40)#299 AS german_movie#287]

(52) AdaptiveSparkPlan
Output [3]: [release_date#285, rating#286, german_movie#287]
Arguments: isFinalPlan=false
Execution Time: 20.808
