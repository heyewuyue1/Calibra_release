...
(6) BroadcastExchange
Input [1]: [id#23]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=539]
...
Input [1]: [id#30]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, false] as bigint)),false), [plan_id=543]
...
Input [1]: [movie_id#33]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=547]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[0, int, true] as bigint), 32) | (cast(input[1, int, true] as bigint) & 4294967295))),false), [plan_id=550]
...
Input [1]: [id#37]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=554]
...
Arguments: hashpartitioning(cast(person_role_id#19 as int), 200), ENSURE_REQUIREMENTS, [plan_id=559]
...
(35) Exchange
Input [2]: [id#9, name#10]
Arguments: hashpartitioning(id#9, 200), ENSURE_REQUIREMENTS, [plan_id=560]
...
Aggregate Attributes [2]: [min#77, min#78]
Results [2]: [min#79, min#80]

(40) Exchange
Input [2]: [min#79, min#80]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=567]

(41) SortAggregate
Input [2]: [min#79, min#80]
Keys: []
Functions [2]: [min(name#10), min(title#40)]
Aggregate Attributes [2]: [min(name#10)#75, min(title#40)#76]
Results [2]: [min(name#10)#75 AS character#68, min(title#40)#76 AS russian_mov_with_actor_producer#69]

(42) AdaptiveSparkPlan
Output [2]: [character#68, russian_mov_with_actor_producer#69]
Arguments: isFinalPlan=false
Execution Time: 16.473
