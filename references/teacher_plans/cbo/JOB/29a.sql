...
Condition : (((((isnotnull(title#40) AND isnotnull(production_year#43)) AND (title#40 = Shrek 2)) AND (cast(production_year#43 as int) >= 2000)) AND (cast(production_year#43 as int) <= 2010)) AND isnotnull(id#39))
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=24724]
...
Input [1]: [id#37]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=24727]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=24731]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[0, int, true] as bigint), 32) | (cast(input[5, int, true] as bigint) & 4294967295))),false), [plan_id=24734]
...
Input [7]: [person_id#17, movie_id#18, person_role_id#19, id#39, title#40, id#540, name#541]
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[5, int, true] as bigint), 32) | (cast(input[0, int, true] as bigint) & 4294967295))),false), [plan_id=24738]
...
(31) Filter
Input [2]: [id#1560, info#1561]
Condition : ((isnotnull(info#1561) AND (info#1561 = trivia)) AND isnotnull(id#1560))
...
Input [1]: [id#1560]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=24742]

(34) BroadcastHashJoin
Left keys [1]: [info_type_id#1555]
Right keys [1]: [id#1560]
Join type: Inner
Join condition: None

(35) Project
Output [5]: [movie_id#18, person_role_id#19, id#39, title#40, name#541]
Input [7]: [movie_id#18, person_role_id#19, id#39, title#40, name#541, info_type_id#1555, id#1560]
...
Input [2]: [id#9, name#10]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, false] as bigint)),false), [plan_id=24746]
...
Input [1]: [id#110]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=24749]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=24753]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[2, int, false] as bigint)),false), [plan_id=24756]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[1, int, true] as bigint), 32) | (cast(input[0, int, true] as bigint) & 4294967295))),false), [plan_id=24760]
...
Input [1]: [id#210]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=24763]
...
Arguments: HashedRelationBroadcastMode(List(input[1, int, true], input[2, int, true], input[0, int, true], input[2, int, true], input[1, int, true], input[0, int, true]),false), [plan_id=24767]
...
Arguments: hashpartitioning(movie_id#18, movie_id#33, movie_id#213, movie_id#116, id#39, 200), ENSURE_REQUIREMENTS, [plan_id=24778]
...
Input [1]: [id#930]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=24769]
...
(83) Filter
Input [2]: [id#1558, kind#1559]
Condition : ((isnotnull(kind#1559) AND (kind#1559 = complete+verified)) AND isnotnull(id#1558))
...
Input [1]: [id#1558]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=24773]

(86) BroadcastHashJoin
Left keys [1]: [status_id#929]
Right keys [1]: [id#1558]
Join type: Inner
Join condition: None

(87) Project
Output [1]: [movie_id#927]
Input [3]: [movie_id#927, status_id#929, id#1558]

(88) Exchange
Input [1]: [movie_id#927]
Arguments: hashpartitioning(cast(movie_id#927 as int), cast(movie_id#927 as int), cast(movie_id#927 as int), cast(movie_id#927 as int), cast(movie_id#927 as int), 200), ENSURE_REQUIREMENTS, [plan_id=24779]
...
Aggregate Attributes [3]: [min#1568, min#1569, min#1570]
Results [3]: [min#1571, min#1572, min#1573]

(93) Exchange
Input [3]: [min#1571, min#1572, min#1573]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=24786]

(94) SortAggregate
Input [3]: [min#1571, min#1572, min#1573]
Keys: []
Functions [3]: [min(name#10), min(name#541), min(title#40)]
Aggregate Attributes [3]: [min(name#10)#1565, min(name#541)#1566, min(title#40)#1567]
Results [3]: [min(name#10)#1565 AS voiced_char#1545, min(name#541)#1566 AS voicing_actress#1546, min(title#40)#1567 AS voiced_animation#1547]

(95) AdaptiveSparkPlan
Output [3]: [voiced_char#1545, voicing_actress#1546, voiced_animation#1547]
