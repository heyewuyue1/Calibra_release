...
(6) BroadcastExchange
Input [1]: [id#210]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=12590]
...
Arguments: hashpartitioning(movie_id#218, 200), ENSURE_REQUIREMENTS, [plan_id=12595]
...
(13) Exchange
Input [3]: [id#39, title#40, production_year#43]
Arguments: hashpartitioning(id#39, 200), ENSURE_REQUIREMENTS, [plan_id=12596]
...
Arguments: hashpartitioning(movie_id#218, movie_id#218, 200), ENSURE_REQUIREMENTS, [plan_id=12603]
...
PushedFilters: [IsNotNull(note), Not(StringContains(note,(as Metro-Goldwyn-Mayer Pictures))), StringContains(note,(co-production)), IsNotNull(company_type_id), IsNotNull(movie_id)]
ReadSchema: struct<movie_id:int,company_type_id:int,note:string>

(19) Filter
Input [3]: [movie_id#33, company_type_id#35, note#36]
Condition : ((((isnotnull(note#36) AND NOT Contains(note#36, (as Metro-Goldwyn-Mayer Pictures))) AND Contains(note#36, (co-production))) AND isnotnull(company_type_id#35)) AND isnotnull(movie_id#33))

(20) Exchange
Input [3]: [movie_id#33, company_type_id#35, note#36]
Arguments: hashpartitioning(movie_id#33, movie_id#33, 200), ENSURE_REQUIREMENTS, [plan_id=12602]
...
Input [1]: [id#30]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=12609]
...
Aggregate Attributes [3]: [min#889, min#890, min#891]
Results [3]: [min#892, min#893, min#894]

(31) Exchange
Input [3]: [min#892, min#893, min#894]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=12614]

(32) SortAggregate
Input [3]: [min#892, min#893, min#894]
Keys: []
Functions [3]: [min(note#36), min(title#40), min(production_year#43)]
Aggregate Attributes [3]: [min(note#36)#886, min(title#40)#887, min(production_year#43)#888]
Results [3]: [min(note#36)#886 AS production_note#878, min(title#40)#887 AS movie_title#879, min(production_year#43)#888 AS movie_year#880]

(33) AdaptiveSparkPlan
Output [3]: [production_note#878, movie_title#879, movie_year#880]
Arguments: isFinalPlan=false
Execution Time: 13.802
