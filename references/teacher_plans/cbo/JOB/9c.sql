...
(7) BroadcastExchange
Input [1]: [id#37]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=37507]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=37511]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[1, int, true] as bigint)),false), [plan_id=37514]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[1, int, true] as bigint), 32) | (cast(input[5, int, false] as bigint) & 4294967295))),false), [plan_id=37517]
...
Input [1]: [id#23]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=37521]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[0, int, true] as bigint), 32) | (cast(input[2, int, true] as bigint) & 4294967295))),false), [plan_id=37525]
...
Arguments: HashedRelationBroadcastMode(List(cast(cast(input[0, string, true] as int) as bigint)),false), [plan_id=37529]
...
Aggregate Attributes [4]: [min#2578, min#2579, min#2580, min#2581]
Results [4]: [min#2582, min#2583, min#2584, min#2585]

(41) Exchange
Input [4]: [min#2582, min#2583, min#2584, min#2585]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=37534]

(42) SortAggregate
Input [4]: [min#2582, min#2583, min#2584, min#2585]
Keys: []
Functions [4]: [min(name#534), min(name#10), min(name#541), min(title#40)]
Aggregate Attributes [4]: [min(name#534)#2574, min(name#10)#2575, min(name#541)#2576, min(title#40)#2577]
Results [4]: [min(name#534)#2574 AS alternative_name#2565, min(name#10)#2575 AS voiced_character_name#2566, min(name#541)#2576 AS voicing_actress#2567, min(title#40)#2577 AS american_movie#2568]

(43) AdaptiveSparkPlan
Output [4]: [alternative_name#2565, voiced_character_name#2566, voicing_actress#2567, american_movie#2568]
Arguments: isFinalPlan=false
Execution Time: 21.644
