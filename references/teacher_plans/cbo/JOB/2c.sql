...
(6) BroadcastExchange
Input [1]: [id#110]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=26664]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=26668]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[0, int, true] as bigint), 32) | (cast(input[1, int, false] as bigint) & 4294967295))),false), [plan_id=26671]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[1, int, true] as bigint)),false), [plan_id=26675]
...
PushedFilters: [IsNotNull(country_code), EqualTo(country_code,[sm]), IsNotNull(id)]
ReadSchema: struct<id:int,country_code:string>

(20) Filter
Input [2]: [id#23, country_code#25]
Condition : ((isnotnull(country_code#25) AND (country_code#25 = [sm])) AND isnotnull(id#23))
...
Aggregate Attributes [1]: [min#1665]
Results [1]: [min#1666]

(25) Exchange
Input [1]: [min#1666]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=26680]

(26) SortAggregate
Input [1]: [min#1666]
Keys: []
Functions [1]: [min(title#40)]
Aggregate Attributes [1]: [min(title#40)#1664]
Results [1]: [min(title#40)#1664 AS movie_title#1658]

(27) AdaptiveSparkPlan
Output [1]: [movie_title#1658]
Arguments: isFinalPlan=false
Execution Time: 12.234
