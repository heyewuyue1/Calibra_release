...
(5) BroadcastExchange
Input [2]: [id#110, keyword#111]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, false] as bigint)),false), [plan_id=33750]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=33754]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[0, int, true] as bigint), 32) | (cast(input[2, int, true] as bigint) & 4294967295))),false), [plan_id=33757]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[2, int, true] as bigint)),false), [plan_id=33761]
...
Aggregate Attributes [3]: [min#2306, min#2307, min#2308]
Results [3]: [min#2309, min#2310, min#2311]

(24) Exchange
Input [3]: [min#2309, min#2310, min#2311]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=33766]

(25) SortAggregate
Input [3]: [min#2309, min#2310, min#2311]
Keys: []
Functions [3]: [min(keyword#111), min(name#541), min(title#40)]
Aggregate Attributes [3]: [min(keyword#111)#2303, min(name#541)#2304, min(title#40)#2305]
Results [3]: [min(keyword#111)#2303 AS movie_keyword#2295, min(name#541)#2304 AS actor_name#2296, min(title#40)#2305 AS hero_movie#2297]

(26) AdaptiveSparkPlan
Output [3]: [movie_keyword#2295, actor_name#2296, hero_movie#2297]
Arguments: isFinalPlan=false
Execution Time: 15.868
