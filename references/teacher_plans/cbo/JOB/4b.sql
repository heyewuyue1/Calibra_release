...
(4) BroadcastExchange
Input [1]: [id#210]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=32496]
...
PushedFilters: [IsNotNull(info), GreaterThan(info,9.0), IsNotNull(info_type_id), IsNotNull(movie_id)]
ReadSchema: struct<movie_id:int,info_type_id:int,info:string>

(6) Filter
Input [3]: [movie_id#218, info_type_id#219, info#220]
Condition : (((isnotnull(info#220) AND (info#220 > 9.0)) AND isnotnull(info_type_id#219)) AND isnotnull(movie_id#218))
...
Arguments: hashpartitioning(movie_id#218, 200), ENSURE_REQUIREMENTS, [plan_id=32501]
...
Arguments: hashpartitioning(id#39, 200), ENSURE_REQUIREMENTS, [plan_id=32502]
...
Arguments: hashpartitioning(movie_id#218, movie_id#218, 200), ENSURE_REQUIREMENTS, [plan_id=32509]
...
(21) Exchange
Input [2]: [movie_id#116, keyword_id#117]
Arguments: hashpartitioning(movie_id#116, movie_id#116, 200), ENSURE_REQUIREMENTS, [plan_id=32508]
...
Arguments: hashpartitioning(keyword_id#117, 200), ENSURE_REQUIREMENTS, [plan_id=32516]
...
(30) Exchange
Input [1]: [id#110]
Arguments: hashpartitioning(id#110, 200), ENSURE_REQUIREMENTS, [plan_id=32517]
...
Aggregate Attributes [2]: [min#2210, min#2211]
Results [2]: [min#2212, min#2213]

(35) Exchange
Input [2]: [min#2212, min#2213]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=32524]

(36) SortAggregate
Input [2]: [min#2212, min#2213]
Keys: []
Functions [2]: [min(info#220), min(title#40)]
Aggregate Attributes [2]: [min(info#220)#2208, min(title#40)#2209]
Results [2]: [min(info#220)#2208 AS rating#2201, min(title#40)#2209 AS movie_title#2202]

(37) AdaptiveSparkPlan
Output [2]: [rating#2201, movie_title#2202]
Arguments: isFinalPlan=false
Execution Time: 14.121
