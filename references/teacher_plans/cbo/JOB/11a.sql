...
(6) BroadcastExchange
Input [1]: [id#110]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=1130]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=1134]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[0, int, true] as bigint), 32) | (cast(input[1, int, true] as bigint) & 4294967295))),false), [plan_id=1137]
...
Input [1]: [id#30]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=1140]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[4, int, true] as bigint)),false), [plan_id=1144]
...
Arguments: HashedRelationBroadcastMode(List(input[0, int, true], input[3, int, true], input[1, int, true]),false), [plan_id=1148]
...
Input [2]: [id#113, link#114]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, false] as bigint)),false), [plan_id=1152]
...
Aggregate Attributes [3]: [min#129, min#130, min#131]
Results [3]: [min#132, min#133, min#134]

(42) Exchange
Input [3]: [min#132, min#133, min#134]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=1157]

(43) SortAggregate
Input [3]: [min#132, min#133, min#134]
Keys: []
Functions [3]: [min(name#24), min(link#114), min(title#40)]
Aggregate Attributes [3]: [min(name#24)#126, min(link#114)#127, min(title#40)#128]
Results [3]: [min(name#24)#126 AS from_company#102, min(link#114)#127 AS movie_link_type#103, min(title#40)#128 AS non_polish_sequel_movie#104]

(44) AdaptiveSparkPlan
Output [3]: [from_company#102, movie_link_type#103, non_polish_sequel_movie#104]
Arguments: isFinalPlan=false
Execution Time: 14.777
