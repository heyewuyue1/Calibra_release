...
(6) BroadcastExchange
Input [1]: [id#210]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=12377]
...
Arguments: hashpartitioning(movie_id#218, 200), ENSURE_REQUIREMENTS, [plan_id=12382]
...
(13) Exchange
Input [3]: [id#39, title#40, production_year#43]
Arguments: hashpartitioning(id#39, 200), ENSURE_REQUIREMENTS, [plan_id=12383]
...
Arguments: hashpartitioning(movie_id#218, movie_id#218, 200), ENSURE_REQUIREMENTS, [plan_id=12390]
...
(20) Exchange
Input [3]: [movie_id#33, company_type_id#35, note#36]
Arguments: hashpartitioning(movie_id#33, movie_id#33, 200), ENSURE_REQUIREMENTS, [plan_id=12389]
...
Input [1]: [id#30]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=12396]
...
Aggregate Attributes [3]: [min#868, min#869, min#870]
Results [3]: [min#871, min#872, min#873]

(31) Exchange
Input [3]: [min#871, min#872, min#873]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=12401]

(32) SortAggregate
Input [3]: [min#871, min#872, min#873]
Keys: []
Functions [3]: [min(note#36), min(title#40), min(production_year#43)]
Aggregate Attributes [3]: [min(note#36)#865, min(title#40)#866, min(production_year#43)#867]
Results [3]: [min(note#36)#865 AS production_note#857, min(title#40)#866 AS movie_title#858, min(production_year#43)#867 AS movie_year#859]

(33) AdaptiveSparkPlan
Output [3]: [production_note#857, movie_title#858, movie_year#859]
Arguments: isFinalPlan=false
Execution Time: 16.451
