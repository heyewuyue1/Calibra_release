...
(6) BroadcastExchange
Input [1]: [id#110]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=26254]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=26258]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[0, int, true] as bigint), 32) | (cast(input[1, int, false] as bigint) & 4294967295))),false), [plan_id=26261]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[1, int, true] as bigint)),false), [plan_id=26265]
...
Aggregate Attributes [1]: [min#1639]
Results [1]: [min#1640]

(25) Exchange
Input [1]: [min#1640]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=26270]

(26) SortAggregate
Input [1]: [min#1640]
Keys: []
Functions [1]: [min(title#40)]
Aggregate Attributes [1]: [min(title#40)#1638]
Results [1]: [min(title#40)#1638 AS movie_title#1632]

(27) AdaptiveSparkPlan
Output [1]: [movie_title#1632]
