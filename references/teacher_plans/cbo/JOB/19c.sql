...
(7) BroadcastExchange
Input [1]: [id#37]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=11561]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=11565]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[1, int, true] as bigint)),false), [plan_id=11568]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[1, int, true] as bigint), 32) | (cast(input[5, int, true] as bigint) & 4294967295))),false), [plan_id=11571]
...
Input [1]: [id#23]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=11574]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[0, int, true] as bigint), 32) | (cast(input[3, int, true] as bigint) & 4294967295))),false), [plan_id=11578]
...
Arguments: HashedRelationBroadcastMode(List(input[5, int, true], input[0, int, true], input[3, int, true]),false), [plan_id=11582]
...
Input [1]: [id#210]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=11586]
...
Arguments: HashedRelationBroadcastMode(List(cast(cast(input[0, string, true] as int) as bigint)),false), [plan_id=11590]
...
Aggregate Attributes [2]: [min#811, min#812]
Results [2]: [min#813, min#814]

(53) Exchange
Input [2]: [min#813, min#814]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=11595]

(54) SortAggregate
Input [2]: [min#813, min#814]
Keys: []
Functions [2]: [min(name#541), min(title#40)]
Aggregate Attributes [2]: [min(name#541)#809, min(title#40)#810]
Results [2]: [min(name#541)#809 AS voicing_actress#802, min(title#40)#810 AS jap_engl_voiced_movie#803]

(55) AdaptiveSparkPlan
Output [2]: [voicing_actress#802, jap_engl_voiced_movie#803]
