...
(6) BroadcastExchange
Input [1]: [id#110]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=14973]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=14977]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[0, int, true] as bigint), 32) | (cast(input[1, int, true] as bigint) & 4294967295))),false), [plan_id=14980]
...
Input [2]: [id#113, link#114]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, false] as bigint)),false), [plan_id=14983]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=14986]
...
Input [1]: [id#30]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=14989]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[1, int, true] as bigint)),false), [plan_id=14993]
...
Arguments: HashedRelationBroadcastMode(List(input[0, int, true], input[1, int, true], input[0, int, true], input[1, int, true], input[0, int, true], input[1, int, true]),false), [plan_id=14997]
...
Aggregate Attributes [3]: [min#1033, min#1034, min#1035]
Results [3]: [min#1036, min#1037, min#1038]

(47) Exchange
Input [3]: [min#1036, min#1037, min#1038]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=15002]

(48) SortAggregate
Input [3]: [min#1036, min#1037, min#1038]
Keys: []
Functions [3]: [min(name#24), min(link#114), min(title#40)]
Aggregate Attributes [3]: [min(name#24)#1030, min(link#114)#1031, min(title#40)#1032]
Results [3]: [min(name#24)#1030 AS company_name#1022, min(link#114)#1031 AS link_type#1023, min(title#40)#1032 AS western_follow_up#1024]

(49) AdaptiveSparkPlan
Output [3]: [company_name#1022, link_type#1023, western_follow_up#1024]
Arguments: isFinalPlan=false
Execution Time: 38.086
