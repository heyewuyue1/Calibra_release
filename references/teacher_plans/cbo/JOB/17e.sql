...
(6) BroadcastExchange
Input [1]: [id#110]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=9349]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=9353]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[0, int, true] as bigint), 32) | (cast(input[1, int, false] as bigint) & 4294967295))),false), [plan_id=9356]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[3, int, false] as bigint)),false), [plan_id=9359]
...
Arguments: HashedRelationBroadcastMode(List(input[2, int, true], input[0, int, true], input[1, int, true]),false), [plan_id=9363]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=9367]
...
Aggregate Attributes [1]: [min#677]
Results [1]: [min#678]

(34) Exchange
Input [1]: [min#678]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=9372]

(35) SortAggregate
Input [1]: [min#678]
Keys: []
Functions [1]: [min(name#541)]
Aggregate Attributes [1]: [min(name#541)#676]
Results [1]: [min(name#541)#676 AS member_in_charnamed_movie#670]

(36) AdaptiveSparkPlan
Output [1]: [member_in_charnamed_movie#670]
Arguments: isFinalPlan=false
Execution Time: 42.829
