...
(6) BroadcastExchange
Input [1]: [id#110]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=26869]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=26873]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[0, int, true] as bigint), 32) | (cast(input[1, int, false] as bigint) & 4294967295))),false), [plan_id=26876]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[1, int, true] as bigint)),false), [plan_id=26880]
...
Aggregate Attributes [1]: [min#1678]
Results [1]: [min#1679]

(25) Exchange
Input [1]: [min#1679]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=26885]

(26) SortAggregate
Input [1]: [min#1679]
Keys: []
Functions [1]: [min(title#40)]
Aggregate Attributes [1]: [min(title#40)#1677]
Results [1]: [min(title#40)#1677 AS movie_title#1671]

(27) AdaptiveSparkPlan
Output [1]: [movie_title#1671]
Arguments: isFinalPlan=false
Execution Time: 12.937
