...
(6) BroadcastExchange
Input [1]: [id#110]
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=8524]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=8528]
...
Arguments: HashedRelationBroadcastMode(List((shiftleft(cast(input[0, int, true] as bigint), 32) | (cast(input[1, int, false] as bigint) & 4294967295))),false), [plan_id=8531]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[3, int, false] as bigint)),false), [plan_id=8534]
...
Arguments: HashedRelationBroadcastMode(List(input[2, int, true], input[0, int, true], input[1, int, true]),false), [plan_id=8538]
...
Arguments: HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=8542]
...
PushedFilters: [IsNotNull(name), StringStartsWith(name,Z), IsNotNull(id)]
ReadSchema: struct<id:int,name:string>

(29) Filter
Input [2]: [id#540, name#541]
Condition : ((isnotnull(name#541) AND StartsWith(name#541, Z)) AND isnotnull(id#540))
...
Aggregate Attributes [1]: [min#636]
Results [1]: [min#637]

(33) Exchange
Input [1]: [min#637]
Arguments: SinglePartition, ENSURE_REQUIREMENTS, [plan_id=8547]

(34) SortAggregate
Input [1]: [min#637]
Keys: []
Functions [1]: [min(name#541)]
Aggregate Attributes [1]: [min(name#541)#634]
Results [2]: [min(name#541)#634 AS member_in_charnamed_movie#627, min(name#541)#634 AS a1#628]

(35) AdaptiveSparkPlan
Output [2]: [member_in_charnamed_movie#627, a1#628]
Arguments: isFinalPlan=false
Execution Time: 61.773
