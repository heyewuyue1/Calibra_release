...
(3) Exchange
Input [6]: [l_orderkey#25L, l_partkey#26L, l_suppkey#27L, l_quantity#29, l_extendedprice#30, l_discount#31]
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=17143]
...
(7) Exchange
Input [2]: [o_orderkey#16L, o_orderdate#20]
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=17144]
...
Arguments: hashpartitioning(l_partkey#26L, 200), ENSURE_REQUIREMENTS, [plan_id=17151]
...
PushedFilters: [IsNotNull(p_name), StringContains(p_name,saddle), IsNotNull(p_partkey)]
ReadSchema: struct<p_partkey:bigint,p_name:string>

(14) Filter
Input [2]: [p_partkey#199L, p_name#200]
Condition : ((isnotnull(p_name#200) AND Contains(p_name#200, saddle)) AND isnotnull(p_partkey#199L))
...
Arguments: hashpartitioning(p_partkey#199L, 200), ENSURE_REQUIREMENTS, [plan_id=17152]
...
(20) Exchange
Input [6]: [l_partkey#26L, l_suppkey#27L, l_quantity#29, l_extendedprice#30, l_discount#31, o_orderdate#20]
Arguments: hashpartitioning(l_suppkey#27L, 200), ENSURE_REQUIREMENTS, [plan_id=17162]
...
Input [2]: [n_nationkey#41L, n_name#42]
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, false]),false), [plan_id=17157]
...
Arguments: hashpartitioning(s_suppkey#208L, 200), ENSURE_REQUIREMENTS, [plan_id=17163]
...
Arguments: hashpartitioning(l_suppkey#27L, l_partkey#26L, 200), ENSURE_REQUIREMENTS, [plan_id=17171]
...
(37) Exchange
Input [3]: [ps_partkey#215L, ps_suppkey#216L, ps_supplycost#218]
Arguments: hashpartitioning(ps_suppkey#216L, ps_partkey#215L, 200), ENSURE_REQUIREMENTS, [plan_id=17170]
...
(40) Project
Output [3]: [n_name#42 AS nation#1425, year(o_orderdate#20) AS o_year#1426, ((l_extendedprice#30 * (1 - l_discount#31)) - (ps_supplycost#218 * l_quantity#29)) AS amount#1427]
...
(41) HashAggregate
Input [3]: [nation#1425, o_year#1426, amount#1427]
Keys [2]: [nation#1425, o_year#1426]
Functions [1]: [partial_sum(amount#1427)]
Aggregate Attributes [2]: [sum#1435, isEmpty#1436]
Results [4]: [nation#1425, o_year#1426, sum#1437, isEmpty#1438]

(42) Exchange
Input [4]: [nation#1425, o_year#1426, sum#1437, isEmpty#1438]
Arguments: hashpartitioning(nation#1425, o_year#1426, 200), ENSURE_REQUIREMENTS, [plan_id=17178]

(43) HashAggregate
Input [4]: [nation#1425, o_year#1426, sum#1437, isEmpty#1438]
Keys [2]: [nation#1425, o_year#1426]
Functions [1]: [sum(amount#1427)]
Aggregate Attributes [1]: [sum(amount#1427)#1434]
Results [3]: [nation#1425, o_year#1426, sum(amount#1427)#1434 AS sum_profit#1428]

(44) Exchange
Input [3]: [nation#1425, o_year#1426, sum_profit#1428]
Arguments: rangepartitioning(nation#1425 ASC NULLS FIRST, o_year#1426 DESC NULLS LAST, 200), ENSURE_REQUIREMENTS, [plan_id=17181]

(45) Sort
Input [3]: [nation#1425, o_year#1426, sum_profit#1428]
Arguments: [nation#1425 ASC NULLS FIRST, o_year#1426 DESC NULLS LAST], true, 0

(46) AdaptiveSparkPlan
Output [3]: [nation#1425, o_year#1426, sum_profit#1428]
Arguments: isFinalPlan=false
Execution Time: 90.788
