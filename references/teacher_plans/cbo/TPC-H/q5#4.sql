...
(3) Exchange
Input [2]: [c_custkey#8L, c_nationkey#11L]
Arguments: hashpartitioning(c_custkey#8L, 200), ENSURE_REQUIREMENTS, [plan_id=8514]
...
Arguments: hashpartitioning(o_custkey#17L, 200), ENSURE_REQUIREMENTS, [plan_id=8515]
...
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=8522]
...
(16) Exchange
Input [4]: [l_orderkey#25L, l_suppkey#27L, l_extendedprice#30, l_discount#31]
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=8523]
...
Arguments: hashpartitioning(l_suppkey#27L, c_nationkey#11L, 200), ENSURE_REQUIREMENTS, [plan_id=8537]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=8528]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=8532]
...
Arguments: hashpartitioning(s_suppkey#208L, s_nationkey#211L, 200), ENSURE_REQUIREMENTS, [plan_id=8538]
...
Aggregate Attributes [2]: [sum#768, isEmpty#769]
Results [3]: [n_name#42, sum#770, isEmpty#771]

(40) Exchange
Input [3]: [n_name#42, sum#770, isEmpty#771]
Arguments: hashpartitioning(n_name#42, 200), ENSURE_REQUIREMENTS, [plan_id=8545]

(41) HashAggregate
Input [3]: [n_name#42, sum#770, isEmpty#771]
Keys [1]: [n_name#42]
Functions [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))]
Aggregate Attributes [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))#767]
Results [2]: [n_name#42, sum((l_extendedprice#30 * (1 - l_discount#31)))#767 AS revenue#761]

(42) Exchange
Input [2]: [n_name#42, revenue#761]
Arguments: rangepartitioning(revenue#761 DESC NULLS LAST, 200), ENSURE_REQUIREMENTS, [plan_id=8548]

(43) Sort
Input [2]: [n_name#42, revenue#761]
Arguments: [revenue#761 DESC NULLS LAST], true, 0

(44) AdaptiveSparkPlan
Output [2]: [n_name#42, revenue#761]
Arguments: isFinalPlan=false
Execution Time: 42.652
