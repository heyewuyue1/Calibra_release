...
(3) Exchange
Input [2]: [c_custkey#8L, c_nationkey#11L]
Arguments: hashpartitioning(c_custkey#8L, 200), ENSURE_REQUIREMENTS, [plan_id=7695]
...
Arguments: hashpartitioning(o_custkey#17L, 200), ENSURE_REQUIREMENTS, [plan_id=7696]
...
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=7703]
...
(16) Exchange
Input [4]: [l_orderkey#25L, l_suppkey#27L, l_extendedprice#30, l_discount#31]
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=7704]
...
Arguments: hashpartitioning(l_suppkey#27L, c_nationkey#11L, 200), ENSURE_REQUIREMENTS, [plan_id=7718]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=7709]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=7713]
...
Arguments: hashpartitioning(s_suppkey#208L, s_nationkey#211L, 200), ENSURE_REQUIREMENTS, [plan_id=7719]
...
Aggregate Attributes [2]: [sum#723, isEmpty#724]
Results [3]: [n_name#42, sum#725, isEmpty#726]

(40) Exchange
Input [3]: [n_name#42, sum#725, isEmpty#726]
Arguments: hashpartitioning(n_name#42, 200), ENSURE_REQUIREMENTS, [plan_id=7726]

(41) HashAggregate
Input [3]: [n_name#42, sum#725, isEmpty#726]
Keys [1]: [n_name#42]
Functions [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))]
Aggregate Attributes [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))#722]
Results [2]: [n_name#42, sum((l_extendedprice#30 * (1 - l_discount#31)))#722 AS revenue#716]

(42) Exchange
Input [2]: [n_name#42, revenue#716]
Arguments: rangepartitioning(revenue#716 DESC NULLS LAST, 200), ENSURE_REQUIREMENTS, [plan_id=7729]

(43) Sort
Input [2]: [n_name#42, revenue#716]
Arguments: [revenue#716 DESC NULLS LAST], true, 0

(44) AdaptiveSparkPlan
Output [2]: [n_name#42, revenue#716]
Arguments: isFinalPlan=false
Execution Time: 42.093
