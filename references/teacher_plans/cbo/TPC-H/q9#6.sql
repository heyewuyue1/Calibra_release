...
(3) Exchange
Input [6]: [l_orderkey#25L, l_partkey#26L, l_suppkey#27L, l_quantity#29, l_extendedprice#30, l_discount#31]
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=17974]
...
(7) Exchange
Input [2]: [o_orderkey#16L, o_orderdate#20]
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=17975]
...
Arguments: hashpartitioning(l_partkey#26L, 200), ENSURE_REQUIREMENTS, [plan_id=17982]
...
PushedFilters: [IsNotNull(p_name), StringContains(p_name,navajo), IsNotNull(p_partkey)]
ReadSchema: struct<p_partkey:bigint,p_name:string>

(14) Filter
Input [2]: [p_partkey#199L, p_name#200]
Condition : ((isnotnull(p_name#200) AND Contains(p_name#200, navajo)) AND isnotnull(p_partkey#199L))
...
Arguments: hashpartitioning(p_partkey#199L, 200), ENSURE_REQUIREMENTS, [plan_id=17983]
...
(20) Exchange
Input [6]: [l_partkey#26L, l_suppkey#27L, l_quantity#29, l_extendedprice#30, l_discount#31, o_orderdate#20]
Arguments: hashpartitioning(l_suppkey#27L, 200), ENSURE_REQUIREMENTS, [plan_id=17993]
...
Input [2]: [n_nationkey#41L, n_name#42]
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, false]),false), [plan_id=17988]
...
Arguments: hashpartitioning(s_suppkey#208L, 200), ENSURE_REQUIREMENTS, [plan_id=17994]
...
Arguments: hashpartitioning(l_suppkey#27L, l_partkey#26L, 200), ENSURE_REQUIREMENTS, [plan_id=18002]
...
(37) Exchange
Input [3]: [ps_partkey#215L, ps_suppkey#216L, ps_supplycost#218]
Arguments: hashpartitioning(ps_suppkey#216L, ps_partkey#215L, 200), ENSURE_REQUIREMENTS, [plan_id=18001]
...
(40) Project
Output [3]: [n_name#42 AS nation#1479, year(o_orderdate#20) AS o_year#1480, ((l_extendedprice#30 * (1 - l_discount#31)) - (ps_supplycost#218 * l_quantity#29)) AS amount#1481]
...
(41) HashAggregate
Input [3]: [nation#1479, o_year#1480, amount#1481]
Keys [2]: [nation#1479, o_year#1480]
Functions [1]: [partial_sum(amount#1481)]
Aggregate Attributes [2]: [sum#1489, isEmpty#1490]
Results [4]: [nation#1479, o_year#1480, sum#1491, isEmpty#1492]

(42) Exchange
Input [4]: [nation#1479, o_year#1480, sum#1491, isEmpty#1492]
Arguments: hashpartitioning(nation#1479, o_year#1480, 200), ENSURE_REQUIREMENTS, [plan_id=18009]

(43) HashAggregate
Input [4]: [nation#1479, o_year#1480, sum#1491, isEmpty#1492]
Keys [2]: [nation#1479, o_year#1480]
Functions [1]: [sum(amount#1481)]
Aggregate Attributes [1]: [sum(amount#1481)#1488]
Results [3]: [nation#1479, o_year#1480, sum(amount#1481)#1488 AS sum_profit#1482]

(44) Exchange
Input [3]: [nation#1479, o_year#1480, sum_profit#1482]
Arguments: rangepartitioning(nation#1479 ASC NULLS FIRST, o_year#1480 DESC NULLS LAST, 200), ENSURE_REQUIREMENTS, [plan_id=18012]

(45) Sort
Input [3]: [nation#1479, o_year#1480, sum_profit#1482]
Arguments: [nation#1479 ASC NULLS FIRST, o_year#1480 DESC NULLS LAST], true, 0

(46) AdaptiveSparkPlan
Output [3]: [nation#1479, o_year#1480, sum_profit#1482]
Arguments: isFinalPlan=false
Execution Time: 93.248
