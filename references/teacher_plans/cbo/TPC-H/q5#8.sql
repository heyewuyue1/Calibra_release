...
(3) Exchange
Input [2]: [c_custkey#8L, c_nationkey#11L]
Arguments: hashpartitioning(c_custkey#8L, 200), ENSURE_REQUIREMENTS, [plan_id=9606]
...
Arguments: hashpartitioning(o_custkey#17L, 200), ENSURE_REQUIREMENTS, [plan_id=9607]
...
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=9614]
...
(16) Exchange
Input [4]: [l_orderkey#25L, l_suppkey#27L, l_extendedprice#30, l_discount#31]
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=9615]
...
Arguments: hashpartitioning(l_suppkey#27L, c_nationkey#11L, 200), ENSURE_REQUIREMENTS, [plan_id=9629]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=9620]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=9624]
...
Arguments: hashpartitioning(s_suppkey#208L, s_nationkey#211L, 200), ENSURE_REQUIREMENTS, [plan_id=9630]
...
Aggregate Attributes [2]: [sum#828, isEmpty#829]
Results [3]: [n_name#42, sum#830, isEmpty#831]

(40) Exchange
Input [3]: [n_name#42, sum#830, isEmpty#831]
Arguments: hashpartitioning(n_name#42, 200), ENSURE_REQUIREMENTS, [plan_id=9637]

(41) HashAggregate
Input [3]: [n_name#42, sum#830, isEmpty#831]
Keys [1]: [n_name#42]
Functions [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))]
Aggregate Attributes [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))#827]
Results [2]: [n_name#42, sum((l_extendedprice#30 * (1 - l_discount#31)))#827 AS revenue#821]

(42) Exchange
Input [2]: [n_name#42, revenue#821]
Arguments: rangepartitioning(revenue#821 DESC NULLS LAST, 200), ENSURE_REQUIREMENTS, [plan_id=9640]

(43) Sort
Input [2]: [n_name#42, revenue#821]
Arguments: [revenue#821 DESC NULLS LAST], true, 0

(44) AdaptiveSparkPlan
Output [2]: [n_name#42, revenue#821]
Arguments: isFinalPlan=false
Execution Time: 42.978
