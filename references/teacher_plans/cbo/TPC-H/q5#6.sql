...
(3) Exchange
Input [2]: [c_custkey#8L, c_nationkey#11L]
Arguments: hashpartitioning(c_custkey#8L, 200), ENSURE_REQUIREMENTS, [plan_id=9060]
...
Arguments: hashpartitioning(o_custkey#17L, 200), ENSURE_REQUIREMENTS, [plan_id=9061]
...
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=9068]
...
(16) Exchange
Input [4]: [l_orderkey#25L, l_suppkey#27L, l_extendedprice#30, l_discount#31]
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=9069]
...
Arguments: hashpartitioning(l_suppkey#27L, c_nationkey#11L, 200), ENSURE_REQUIREMENTS, [plan_id=9083]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=9074]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=9078]
...
Arguments: hashpartitioning(s_suppkey#208L, s_nationkey#211L, 200), ENSURE_REQUIREMENTS, [plan_id=9084]
...
Aggregate Attributes [2]: [sum#798, isEmpty#799]
Results [3]: [n_name#42, sum#800, isEmpty#801]

(40) Exchange
Input [3]: [n_name#42, sum#800, isEmpty#801]
Arguments: hashpartitioning(n_name#42, 200), ENSURE_REQUIREMENTS, [plan_id=9091]

(41) HashAggregate
Input [3]: [n_name#42, sum#800, isEmpty#801]
Keys [1]: [n_name#42]
Functions [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))]
Aggregate Attributes [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))#797]
Results [2]: [n_name#42, sum((l_extendedprice#30 * (1 - l_discount#31)))#797 AS revenue#791]

(42) Exchange
Input [2]: [n_name#42, revenue#791]
Arguments: rangepartitioning(revenue#791 DESC NULLS LAST, 200), ENSURE_REQUIREMENTS, [plan_id=9094]

(43) Sort
Input [2]: [n_name#42, revenue#791]
Arguments: [revenue#791 DESC NULLS LAST], true, 0

(44) AdaptiveSparkPlan
Output [2]: [n_name#42, revenue#791]
Arguments: isFinalPlan=false
Execution Time: 42.866
