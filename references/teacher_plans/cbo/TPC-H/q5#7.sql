...
(3) Exchange
Input [2]: [c_custkey#8L, c_nationkey#11L]
Arguments: hashpartitioning(c_custkey#8L, 200), ENSURE_REQUIREMENTS, [plan_id=9333]
...
Condition : ((((isnotnull(o_orderdate#20) AND (o_orderdate#20 >= 1994-01-01)) AND (o_orderdate#20 < 1995-01-01)) AND isnotnull(o_custkey#17L)) AND isnotnull(o_orderkey#16L))
...
Arguments: hashpartitioning(o_custkey#17L, 200), ENSURE_REQUIREMENTS, [plan_id=9334]
...
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=9341]
...
(16) Exchange
Input [4]: [l_orderkey#25L, l_suppkey#27L, l_extendedprice#30, l_discount#31]
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=9342]
...
Arguments: hashpartitioning(l_suppkey#27L, c_nationkey#11L, 200), ENSURE_REQUIREMENTS, [plan_id=9356]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=9347]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=9351]
...
Arguments: hashpartitioning(s_suppkey#208L, s_nationkey#211L, 200), ENSURE_REQUIREMENTS, [plan_id=9357]
...
Aggregate Attributes [2]: [sum#813, isEmpty#814]
Results [3]: [n_name#42, sum#815, isEmpty#816]

(40) Exchange
Input [3]: [n_name#42, sum#815, isEmpty#816]
Arguments: hashpartitioning(n_name#42, 200), ENSURE_REQUIREMENTS, [plan_id=9364]

(41) HashAggregate
Input [3]: [n_name#42, sum#815, isEmpty#816]
Keys [1]: [n_name#42]
Functions [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))]
Aggregate Attributes [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))#812]
Results [2]: [n_name#42, sum((l_extendedprice#30 * (1 - l_discount#31)))#812 AS revenue#806]

(42) Exchange
Input [2]: [n_name#42, revenue#806]
Arguments: rangepartitioning(revenue#806 DESC NULLS LAST, 200), ENSURE_REQUIREMENTS, [plan_id=9367]

(43) Sort
Input [2]: [n_name#42, revenue#806]
Arguments: [revenue#806 DESC NULLS LAST], true, 0

(44) AdaptiveSparkPlan
Output [2]: [n_name#42, revenue#806]
Arguments: isFinalPlan=false
Execution Time: 42.182
