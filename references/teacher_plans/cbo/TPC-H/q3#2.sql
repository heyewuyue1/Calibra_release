...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=6163]
...
PushedFilters: [IsNotNull(o_orderdate), LessThan(o_orderdate,1995-03-03), IsNotNull(o_custkey), IsNotNull(o_orderkey)]
...
Condition : (((isnotnull(o_orderdate#20) AND (o_orderdate#20 < 1995-03-03)) AND isnotnull(o_custkey#17L)) AND isnotnull(o_orderkey#16L))
...
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=6168]
...
PushedFilters: [IsNotNull(l_shipdate), GreaterThan(l_shipdate,1995-03-03), IsNotNull(l_orderkey)]
...
Condition : ((isnotnull(l_shipdate#35) AND (l_shipdate#35 > 1995-03-03)) AND isnotnull(l_orderkey#25L))
...
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=6169]
...
Aggregate Attributes [2]: [sum#588, isEmpty#589]
Results [5]: [l_orderkey#25L, o_orderdate#20, o_shippriority#23, sum#590, isEmpty#591]

(19) HashAggregate
Input [5]: [l_orderkey#25L, o_orderdate#20, o_shippriority#23, sum#590, isEmpty#591]
Keys [3]: [l_orderkey#25L, o_orderdate#20, o_shippriority#23]
Functions [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))]
Aggregate Attributes [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))#587]
Results [4]: [l_orderkey#25L, sum((l_extendedprice#30 * (1 - l_discount#31)))#587 AS revenue#581, o_orderdate#20, o_shippriority#23]

(20) TakeOrderedAndProject
Input [4]: [l_orderkey#25L, revenue#581, o_orderdate#20, o_shippriority#23]
Arguments: 10, [revenue#581 DESC NULLS LAST, o_orderdate#20 ASC NULLS FIRST], [l_orderkey#25L, revenue#581, o_orderdate#20, o_shippriority#23]

(21) AdaptiveSparkPlan
Output [4]: [l_orderkey#25L, revenue#581, o_orderdate#20, o_shippriority#23]
Arguments: isFinalPlan=false
Execution Time: 31.081
