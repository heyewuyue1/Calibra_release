...
(3) Exchange
Input [6]: [l_orderkey#25L, l_partkey#26L, l_suppkey#27L, l_quantity#29, l_extendedprice#30, l_discount#31]
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=17420]
...
(7) Exchange
Input [2]: [o_orderkey#16L, o_orderdate#20]
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=17421]
...
Arguments: hashpartitioning(l_partkey#26L, 200), ENSURE_REQUIREMENTS, [plan_id=17428]
...
PushedFilters: [IsNotNull(p_name), StringContains(p_name,puff), IsNotNull(p_partkey)]
ReadSchema: struct<p_partkey:bigint,p_name:string>

(14) Filter
Input [2]: [p_partkey#199L, p_name#200]
Condition : ((isnotnull(p_name#200) AND Contains(p_name#200, puff)) AND isnotnull(p_partkey#199L))
...
Arguments: hashpartitioning(p_partkey#199L, 200), ENSURE_REQUIREMENTS, [plan_id=17429]
...
(20) Exchange
Input [6]: [l_partkey#26L, l_suppkey#27L, l_quantity#29, l_extendedprice#30, l_discount#31, o_orderdate#20]
Arguments: hashpartitioning(l_suppkey#27L, 200), ENSURE_REQUIREMENTS, [plan_id=17439]
...
Input [2]: [n_nationkey#41L, n_name#42]
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, false]),false), [plan_id=17434]
...
Arguments: hashpartitioning(s_suppkey#208L, 200), ENSURE_REQUIREMENTS, [plan_id=17440]
...
Arguments: hashpartitioning(l_suppkey#27L, l_partkey#26L, 200), ENSURE_REQUIREMENTS, [plan_id=17448]
...
(37) Exchange
Input [3]: [ps_partkey#215L, ps_suppkey#216L, ps_supplycost#218]
Arguments: hashpartitioning(ps_suppkey#216L, ps_partkey#215L, 200), ENSURE_REQUIREMENTS, [plan_id=17447]
...
(40) Project
Output [3]: [n_name#42 AS nation#1443, year(o_orderdate#20) AS o_year#1444, ((l_extendedprice#30 * (1 - l_discount#31)) - (ps_supplycost#218 * l_quantity#29)) AS amount#1445]
...
(41) HashAggregate
Input [3]: [nation#1443, o_year#1444, amount#1445]
Keys [2]: [nation#1443, o_year#1444]
Functions [1]: [partial_sum(amount#1445)]
Aggregate Attributes [2]: [sum#1453, isEmpty#1454]
Results [4]: [nation#1443, o_year#1444, sum#1455, isEmpty#1456]

(42) Exchange
Input [4]: [nation#1443, o_year#1444, sum#1455, isEmpty#1456]
Arguments: hashpartitioning(nation#1443, o_year#1444, 200), ENSURE_REQUIREMENTS, [plan_id=17455]

(43) HashAggregate
Input [4]: [nation#1443, o_year#1444, sum#1455, isEmpty#1456]
Keys [2]: [nation#1443, o_year#1444]
Functions [1]: [sum(amount#1445)]
Aggregate Attributes [1]: [sum(amount#1445)#1452]
Results [3]: [nation#1443, o_year#1444, sum(amount#1445)#1452 AS sum_profit#1446]

(44) Exchange
Input [3]: [nation#1443, o_year#1444, sum_profit#1446]
Arguments: rangepartitioning(nation#1443 ASC NULLS FIRST, o_year#1444 DESC NULLS LAST, 200), ENSURE_REQUIREMENTS, [plan_id=17458]

(45) Sort
Input [3]: [nation#1443, o_year#1444, sum_profit#1446]
Arguments: [nation#1443 ASC NULLS FIRST, o_year#1444 DESC NULLS LAST], true, 0

(46) AdaptiveSparkPlan
Output [3]: [nation#1443, o_year#1444, sum_profit#1446]
Arguments: isFinalPlan=false
Execution Time: 93.525
