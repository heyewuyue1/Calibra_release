...
(5) BroadcastExchange
Input [2]: [n_nationkey#41L, n_name#42]
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, false]),false), [plan_id=916]
...
Arguments: hashpartitioning(c_custkey#8L, 200), ENSURE_REQUIREMENTS, [plan_id=921]
...
PushedFilters: [IsNotNull(o_orderdate), GreaterThanOrEqual(o_orderdate,1994-02-01), LessThan(o_orderdate,1994-05-01), IsNotNull(o_custkey), IsNotNull(o_orderkey)]
ReadSchema: struct<o_orderkey:bigint,o_custkey:bigint,o_orderdate:date>

(11) Filter
Input [3]: [o_orderkey#16L, o_custkey#17L, o_orderdate#20]
Condition : ((((isnotnull(o_orderdate#20) AND (o_orderdate#20 >= 1994-02-01)) AND (o_orderdate#20 < 1994-05-01)) AND isnotnull(o_custkey#17L)) AND isnotnull(o_orderkey#16L))
...
Arguments: hashpartitioning(o_custkey#17L, 200), ENSURE_REQUIREMENTS, [plan_id=922]
...
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=929]
...
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=930]
...
Results [9]: [c_custkey#8L, c_name#9, c_acctbal#13, c_phone#12, n_name#42, c_address#10, c_comment#15, sum#112, isEmpty#113]

(27) Exchange
Input [9]: [c_custkey#8L, c_name#9, c_acctbal#13, c_phone#12, n_name#42, c_address#10, c_comment#15, sum#112, isEmpty#113]
Arguments: hashpartitioning(c_custkey#8L, c_name#9, c_acctbal#13, c_phone#12, n_name#42, c_address#10, c_comment#15, 200), ENSURE_REQUIREMENTS, [plan_id=937]

(28) HashAggregate
Input [9]: [c_custkey#8L, c_name#9, c_acctbal#13, c_phone#12, n_name#42, c_address#10, c_comment#15, sum#112, isEmpty#113]
Keys [7]: [c_custkey#8L, c_name#9, c_acctbal#13, c_phone#12, n_name#42, c_address#10, c_comment#15]
Functions [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))]
Aggregate Attributes [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))#109]
Results [8]: [c_custkey#8L, c_name#9, sum((l_extendedprice#30 * (1 - l_discount#31)))#109 AS revenue#103, c_acctbal#13, n_name#42, c_address#10, c_phone#12, c_comment#15]

(29) TakeOrderedAndProject
Input [8]: [c_custkey#8L, c_name#9, revenue#103, c_acctbal#13, n_name#42, c_address#10, c_phone#12, c_comment#15]
Arguments: 20, [revenue#103 DESC NULLS LAST], [c_custkey#8L, c_name#9, revenue#103, c_acctbal#13, n_name#42, c_address#10, c_phone#12, c_comment#15]

(30) AdaptiveSparkPlan
Output [8]: [c_custkey#8L, c_name#9, revenue#103, c_acctbal#13, n_name#42, c_address#10, c_phone#12, c_comment#15]
Arguments: isFinalPlan=false
Execution Time: 30.518
