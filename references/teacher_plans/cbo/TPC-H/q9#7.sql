...
(3) Exchange
Input [6]: [l_orderkey#25L, l_partkey#26L, l_suppkey#27L, l_quantity#29, l_extendedprice#30, l_discount#31]
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=18251]
...
(7) Exchange
Input [2]: [o_orderkey#16L, o_orderdate#20]
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=18252]
...
Arguments: hashpartitioning(l_partkey#26L, 200), ENSURE_REQUIREMENTS, [plan_id=18259]
...
PushedFilters: [IsNotNull(p_name), StringContains(p_name,medium), IsNotNull(p_partkey)]
ReadSchema: struct<p_partkey:bigint,p_name:string>

(14) Filter
Input [2]: [p_partkey#199L, p_name#200]
Condition : ((isnotnull(p_name#200) AND Contains(p_name#200, medium)) AND isnotnull(p_partkey#199L))
...
Arguments: hashpartitioning(p_partkey#199L, 200), ENSURE_REQUIREMENTS, [plan_id=18260]
...
(20) Exchange
Input [6]: [l_partkey#26L, l_suppkey#27L, l_quantity#29, l_extendedprice#30, l_discount#31, o_orderdate#20]
Arguments: hashpartitioning(l_suppkey#27L, 200), ENSURE_REQUIREMENTS, [plan_id=18270]
...
Input [2]: [n_nationkey#41L, n_name#42]
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, false]),false), [plan_id=18265]
...
Arguments: hashpartitioning(s_suppkey#208L, 200), ENSURE_REQUIREMENTS, [plan_id=18271]
...
Arguments: hashpartitioning(l_suppkey#27L, l_partkey#26L, 200), ENSURE_REQUIREMENTS, [plan_id=18279]
...
(37) Exchange
Input [3]: [ps_partkey#215L, ps_suppkey#216L, ps_supplycost#218]
Arguments: hashpartitioning(ps_suppkey#216L, ps_partkey#215L, 200), ENSURE_REQUIREMENTS, [plan_id=18278]
...
(40) Project
Output [3]: [n_name#42 AS nation#1497, year(o_orderdate#20) AS o_year#1498, ((l_extendedprice#30 * (1 - l_discount#31)) - (ps_supplycost#218 * l_quantity#29)) AS amount#1499]
...
(41) HashAggregate
Input [3]: [nation#1497, o_year#1498, amount#1499]
Keys [2]: [nation#1497, o_year#1498]
Functions [1]: [partial_sum(amount#1499)]
Aggregate Attributes [2]: [sum#1507, isEmpty#1508]
Results [4]: [nation#1497, o_year#1498, sum#1509, isEmpty#1510]

(42) Exchange
Input [4]: [nation#1497, o_year#1498, sum#1509, isEmpty#1510]
Arguments: hashpartitioning(nation#1497, o_year#1498, 200), ENSURE_REQUIREMENTS, [plan_id=18286]

(43) HashAggregate
Input [4]: [nation#1497, o_year#1498, sum#1509, isEmpty#1510]
Keys [2]: [nation#1497, o_year#1498]
Functions [1]: [sum(amount#1499)]
Aggregate Attributes [1]: [sum(amount#1499)#1506]
Results [3]: [nation#1497, o_year#1498, sum(amount#1499)#1506 AS sum_profit#1500]

(44) Exchange
Input [3]: [nation#1497, o_year#1498, sum_profit#1500]
Arguments: rangepartitioning(nation#1497 ASC NULLS FIRST, o_year#1498 DESC NULLS LAST, 200), ENSURE_REQUIREMENTS, [plan_id=18289]

(45) Sort
Input [3]: [nation#1497, o_year#1498, sum_profit#1500]
Arguments: [nation#1497 ASC NULLS FIRST, o_year#1498 DESC NULLS LAST], true, 0

(46) AdaptiveSparkPlan
Output [3]: [nation#1497, o_year#1498, sum_profit#1500]
Arguments: isFinalPlan=false
Execution Time: 93.165
