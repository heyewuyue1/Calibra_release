...
(3) Exchange
Input [2]: [c_custkey#8L, c_nationkey#11L]
Arguments: hashpartitioning(c_custkey#8L, 200), ENSURE_REQUIREMENTS, [plan_id=8241]
...
Arguments: hashpartitioning(o_custkey#17L, 200), ENSURE_REQUIREMENTS, [plan_id=8242]
...
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=8249]
...
(16) Exchange
Input [4]: [l_orderkey#25L, l_suppkey#27L, l_extendedprice#30, l_discount#31]
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=8250]
...
Arguments: hashpartitioning(l_suppkey#27L, c_nationkey#11L, 200), ENSURE_REQUIREMENTS, [plan_id=8264]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=8255]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=8259]
...
Arguments: hashpartitioning(s_suppkey#208L, s_nationkey#211L, 200), ENSURE_REQUIREMENTS, [plan_id=8265]
...
Aggregate Attributes [2]: [sum#753, isEmpty#754]
Results [3]: [n_name#42, sum#755, isEmpty#756]

(40) Exchange
Input [3]: [n_name#42, sum#755, isEmpty#756]
Arguments: hashpartitioning(n_name#42, 200), ENSURE_REQUIREMENTS, [plan_id=8272]

(41) HashAggregate
Input [3]: [n_name#42, sum#755, isEmpty#756]
Keys [1]: [n_name#42]
Functions [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))]
Aggregate Attributes [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))#752]
Results [2]: [n_name#42, sum((l_extendedprice#30 * (1 - l_discount#31)))#752 AS revenue#746]

(42) Exchange
Input [2]: [n_name#42, revenue#746]
Arguments: rangepartitioning(revenue#746 DESC NULLS LAST, 200), ENSURE_REQUIREMENTS, [plan_id=8275]

(43) Sort
Input [2]: [n_name#42, revenue#746]
Arguments: [revenue#746 DESC NULLS LAST], true, 0

(44) AdaptiveSparkPlan
Output [2]: [n_name#42, revenue#746]
Arguments: isFinalPlan=false
Execution Time: 42.049
