...
(3) Exchange
Input [2]: [c_custkey#8L, c_nationkey#11L]
Arguments: hashpartitioning(c_custkey#8L, 200), ENSURE_REQUIREMENTS, [plan_id=8787]
...
Arguments: hashpartitioning(o_custkey#17L, 200), ENSURE_REQUIREMENTS, [plan_id=8788]
...
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=8795]
...
(16) Exchange
Input [4]: [l_orderkey#25L, l_suppkey#27L, l_extendedprice#30, l_discount#31]
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=8796]
...
Arguments: hashpartitioning(l_suppkey#27L, c_nationkey#11L, 200), ENSURE_REQUIREMENTS, [plan_id=8810]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=8801]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=8805]
...
Arguments: hashpartitioning(s_suppkey#208L, s_nationkey#211L, 200), ENSURE_REQUIREMENTS, [plan_id=8811]
...
Aggregate Attributes [2]: [sum#783, isEmpty#784]
Results [3]: [n_name#42, sum#785, isEmpty#786]

(40) Exchange
Input [3]: [n_name#42, sum#785, isEmpty#786]
Arguments: hashpartitioning(n_name#42, 200), ENSURE_REQUIREMENTS, [plan_id=8818]

(41) HashAggregate
Input [3]: [n_name#42, sum#785, isEmpty#786]
Keys [1]: [n_name#42]
Functions [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))]
Aggregate Attributes [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))#782]
Results [2]: [n_name#42, sum((l_extendedprice#30 * (1 - l_discount#31)))#782 AS revenue#776]

(42) Exchange
Input [2]: [n_name#42, revenue#776]
Arguments: rangepartitioning(revenue#776 DESC NULLS LAST, 200), ENSURE_REQUIREMENTS, [plan_id=8821]

(43) Sort
Input [2]: [n_name#42, revenue#776]
Arguments: [revenue#776 DESC NULLS LAST], true, 0

(44) AdaptiveSparkPlan
Output [2]: [n_name#42, revenue#776]
Arguments: isFinalPlan=false
Execution Time: 42.662
