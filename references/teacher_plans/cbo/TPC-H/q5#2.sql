...
(3) Exchange
Input [2]: [c_custkey#8L, c_nationkey#11L]
Arguments: hashpartitioning(c_custkey#8L, 200), ENSURE_REQUIREMENTS, [plan_id=7968]
...
Arguments: hashpartitioning(o_custkey#17L, 200), ENSURE_REQUIREMENTS, [plan_id=7969]
...
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=7976]
...
(16) Exchange
Input [4]: [l_orderkey#25L, l_suppkey#27L, l_extendedprice#30, l_discount#31]
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=7977]
...
Arguments: hashpartitioning(l_suppkey#27L, c_nationkey#11L, 200), ENSURE_REQUIREMENTS, [plan_id=7991]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=7982]
...
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, true]),false), [plan_id=7986]
...
Arguments: hashpartitioning(s_suppkey#208L, s_nationkey#211L, 200), ENSURE_REQUIREMENTS, [plan_id=7992]
...
Aggregate Attributes [2]: [sum#738, isEmpty#739]
Results [3]: [n_name#42, sum#740, isEmpty#741]

(40) Exchange
Input [3]: [n_name#42, sum#740, isEmpty#741]
Arguments: hashpartitioning(n_name#42, 200), ENSURE_REQUIREMENTS, [plan_id=7999]

(41) HashAggregate
Input [3]: [n_name#42, sum#740, isEmpty#741]
Keys [1]: [n_name#42]
Functions [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))]
Aggregate Attributes [1]: [sum((l_extendedprice#30 * (1 - l_discount#31)))#737]
Results [2]: [n_name#42, sum((l_extendedprice#30 * (1 - l_discount#31)))#737 AS revenue#731]

(42) Exchange
Input [2]: [n_name#42, revenue#731]
Arguments: rangepartitioning(revenue#731 DESC NULLS LAST, 200), ENSURE_REQUIREMENTS, [plan_id=8002]

(43) Sort
Input [2]: [n_name#42, revenue#731]
Arguments: [revenue#731 DESC NULLS LAST], true, 0

(44) AdaptiveSparkPlan
Output [2]: [n_name#42, revenue#731]
Arguments: isFinalPlan=false
Execution Time: 43.115
