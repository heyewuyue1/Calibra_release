...
(3) Exchange
Input [6]: [l_orderkey#25L, l_partkey#26L, l_suppkey#27L, l_quantity#29, l_extendedprice#30, l_discount#31]
Arguments: hashpartitioning(l_orderkey#25L, 200), ENSURE_REQUIREMENTS, [plan_id=16312]
...
(7) Exchange
Input [2]: [o_orderkey#16L, o_orderdate#20]
Arguments: hashpartitioning(o_orderkey#16L, 200), ENSURE_REQUIREMENTS, [plan_id=16313]
...
Arguments: hashpartitioning(l_partkey#26L, 200), ENSURE_REQUIREMENTS, [plan_id=16320]
...
PushedFilters: [IsNotNull(p_name), StringContains(p_name,thistle), IsNotNull(p_partkey)]
ReadSchema: struct<p_partkey:bigint,p_name:string>

(14) Filter
Input [2]: [p_partkey#199L, p_name#200]
Condition : ((isnotnull(p_name#200) AND Contains(p_name#200, thistle)) AND isnotnull(p_partkey#199L))
...
Arguments: hashpartitioning(p_partkey#199L, 200), ENSURE_REQUIREMENTS, [plan_id=16321]
...
(20) Exchange
Input [6]: [l_partkey#26L, l_suppkey#27L, l_quantity#29, l_extendedprice#30, l_discount#31, o_orderdate#20]
Arguments: hashpartitioning(l_suppkey#27L, 200), ENSURE_REQUIREMENTS, [plan_id=16331]
...
Input [2]: [n_nationkey#41L, n_name#42]
Arguments: HashedRelationBroadcastMode(List(input[0, bigint, false]),false), [plan_id=16326]
...
Arguments: hashpartitioning(s_suppkey#208L, 200), ENSURE_REQUIREMENTS, [plan_id=16332]
...
Arguments: hashpartitioning(l_suppkey#27L, l_partkey#26L, 200), ENSURE_REQUIREMENTS, [plan_id=16340]
...
(37) Exchange
Input [3]: [ps_partkey#215L, ps_suppkey#216L, ps_supplycost#218]
Arguments: hashpartitioning(ps_suppkey#216L, ps_partkey#215L, 200), ENSURE_REQUIREMENTS, [plan_id=16339]
...
(40) Project
Output [3]: [n_name#42 AS nation#1371, year(o_orderdate#20) AS o_year#1372, ((l_extendedprice#30 * (1 - l_discount#31)) - (ps_supplycost#218 * l_quantity#29)) AS amount#1373]
...
(41) HashAggregate
Input [3]: [nation#1371, o_year#1372, amount#1373]
Keys [2]: [nation#1371, o_year#1372]
Functions [1]: [partial_sum(amount#1373)]
Aggregate Attributes [2]: [sum#1381, isEmpty#1382]
Results [4]: [nation#1371, o_year#1372, sum#1383, isEmpty#1384]

(42) Exchange
Input [4]: [nation#1371, o_year#1372, sum#1383, isEmpty#1384]
Arguments: hashpartitioning(nation#1371, o_year#1372, 200), ENSURE_REQUIREMENTS, [plan_id=16347]

(43) HashAggregate
Input [4]: [nation#1371, o_year#1372, sum#1383, isEmpty#1384]
Keys [2]: [nation#1371, o_year#1372]
Functions [1]: [sum(amount#1373)]
Aggregate Attributes [1]: [sum(amount#1373)#1380]
Results [3]: [nation#1371, o_year#1372, sum(amount#1373)#1380 AS sum_profit#1374]

(44) Exchange
Input [3]: [nation#1371, o_year#1372, sum_profit#1374]
Arguments: rangepartitioning(nation#1371 ASC NULLS FIRST, o_year#1372 DESC NULLS LAST, 200), ENSURE_REQUIREMENTS, [plan_id=16350]

(45) Sort
Input [3]: [nation#1371, o_year#1372, sum_profit#1374]
Arguments: [nation#1371 ASC NULLS FIRST, o_year#1372 DESC NULLS LAST], true, 0

(46) AdaptiveSparkPlan
Output [3]: [nation#1371, o_year#1372, sum_profit#1374]
Arguments: isFinalPlan=false
Execution Time: 96.01
